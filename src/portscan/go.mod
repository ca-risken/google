module github.com/CyberAgent/mimosa-google/src/portscan
...
require (
	...
	github.com/CyberAgent/mimosa-google/pkg/common v0.0.0-20210602143342-b22565ebcfd2
	github.com/CyberAgent/mimosa-google/proto/google v0.0.0-20210602143342-b22565ebcfd2
