...
func (d *dataSourceRecommend) DataSource() string {
	return common.PortscanDataSource
}

func (d *dataSourceRecommend) ScanFailureRisk() string {
	return fmt.Sprintf("Failed to scan %s, So you are not gathering the latest security threat information.", common.PortscanDataSource)
}
